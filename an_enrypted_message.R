...
# have gathered intelligance from eyewitness accounts of the conspirators.
# Witness's overheard mystery person one as saying there homeworld was "Concord Dawn"
...
# The enrycpted message can be decoded by combining the two seed codes from each mystery person.
